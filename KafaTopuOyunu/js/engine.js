...
function createScene() {
    ...
    cf.add(camera.position, 'x', 0, 50).onChange(function () { camera.lookAt(new THREE.Vector3(0, 0, 0)); });
    cf.add(camera.position, 'y', 0, 80).onChange(function () { camera.lookAt(new THREE.Vector3(0, 0, 0)); });
